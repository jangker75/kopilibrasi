<?php namespace App\Http\Controllers;
	...
	class AdminMCustomerController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->form[] = ['label'=>'Notes','name'=>'notes','type'=>'textarea','validation'=>'|min:1|max:255','width'=>'col-sm-10'];
